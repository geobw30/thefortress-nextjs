      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="fade-in">
            <h3 className="text-xl font-bold mb-4">The Fortress</h3>
          ...
          <div className="fade-in">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/impact" className="text-gray-400 hover:text-white transition duration-300">Impact</Link></li>
              <li><Link href="/donate" className="text-gray-400 hover:text-white transition duration-300">Donate</Link></li>
            </ul>
          </div>
          ...
          <div className="fade-in">
            ...
            <ul className="space-y-2">
              <li><Link href="/volunteer" className="text-gray-400 hover:text-white transition duration-300">Volunteer</Link></li>
          ...
          <div className="fade-in">
            ...
            <address className="not-italic text-gray-400">
              <p className="mb-2">123 Community Street</p>
              <p className="mb-2">Nairobi, Kenya</p>
              <p className="mb-2">Email: info@thefortress.org</p>
              <p className="mb-4">Phone: +254 123 456 789</p>
