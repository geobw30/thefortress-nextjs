...
const AboutSection = () => {
  return (
    <section className="h-screen flex items-center justify-center py-16 px-4 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 fade-in">
          ...
          <div className="md:w-1/2">
            <div
              className="bg-secondary rounded-xl w-full h-96 bg-cover bg-center bg-no-repeat"
